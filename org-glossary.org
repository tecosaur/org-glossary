...
text, or another link, etc.). In addition, terms in headings are ignored, as
this is considered broadly desirable. This behaviour can be changed by setting
~org-glossary-skip-headings~ to ~nil~.
