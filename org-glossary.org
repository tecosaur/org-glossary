...
titled =Glossary= or =Acronym= and therein define terms using an Org definition
list, like so:
...
+ Link uses of terms with there definitions, in a backend-appropriate manner
...
favourate ML with a unicorn mascot. It attempts to provide powerful
...
terms and listing occurrences; which may take the form of a glossary, index, or
